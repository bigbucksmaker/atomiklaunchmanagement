...
const SEED_LEADS = [
  ...
  createLead({ name: 'Composio', amplificationTier: '3M', budgetInputted: '$100,000', closedAmount: '$107,000.00', companyOneLiner: 'AI agent infrastructure platform that provides production-ready tool.', funding: '$29M total', launchDate: '2026-03-27', launchVideoVendor: 'Atomik', source: 'X', status: '6. MSA sent', website: 'https://composio.dev/' }),
